...
function ProductCard({ product, onNavigate, onAddToCart }) {
  ...
  return (
    <div className="product-card" onClick={() => onNavigate(product.id)} style={{ cursor: 'pointer' }}>
      ...
      <div className="product-price"><img src={coinImg} alt="VC" className="coin-icon" /> {product.price_vc}</div>
        ...
        <div className="footer-inner">
          ...
          <div className="footer-contact-col">
            ...
            <div className="footer-contact-item">
              ...
              <a href="tel:+918147930697" style={{ color: 'inherit', textDecoration: 'none' }}>81479 30697</a>
            </div>
            <div className="footer-contact-item">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
              <a href="mailto:Ecellatalliance@gmail.com" style={{ color: 'inherit', textDecoration: 'none' }}>Ecellatalliance@gmail.com</a>
            </div>
